...
def consultarCliente(request):
    ...
    #quando a solicitação (request) usa o método GET é solicitada a renderização da interface consultarCliente.html
        ...
        return render(request, "compra_ingressos/consultarCliente.html")
...
def atualizarDadosCliente(request, cpfPessoa = None):
    ...
    if request.method == "POST":        
        ...
        return render(request,"compra_ingressos/atualizarDadosCliente.html",context)
    ...
    return render(request, "compra_ingressos/atualizarDadosCliente.html")
...
def abrirConta(request):
    ...
    if request.method == "POST":        
        ...
        return render(request, "compra_ingressos/abrirConta.html")
...
def realizarDeposito(request):
    ...
    if request.method == "POST":    
        ...
        if conta:
            ...
            return render(request,"compra_ingressos/realizarDeposito.html",context)
        else:
            context = {
        ...
        return render(request, "compra_ingressos/realizarDeposito.html")
...
def emitirExtrato(request):
    return render(request, "compra_ingressos/emitirExtrato.html")

def emitirSaldo(request):
    return render(request, "compra_ingressos/emitirSaldo.html")

def encerrarConta(request):
    return render(request, "compra_ingressos/encerrarConta.html")


def realizarSaque(request):
    return render(request, "compra_ingressos/realizarSaque.html")

def gerenciarClientes(request):
    return render(request, "compra_ingressos/gerenciarClientes.html")
'''
